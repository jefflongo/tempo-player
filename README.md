...
This application will not be available on until [crates.io](https://crates.io/) until [yt-dlp video searching](https://github.com/boul2gom/yt-dlp/issues/314) is fixed. Until then, install locally:
```bash
cargo install --path .
```
